...
(function () {
  ...
  loadPackage({
    files: [
      ...
      {
        filename: '/third_party/mediapipe/modules/palm_detection/palm_detection_full.tflite',
        start: 11,
        end: 2341291,
      },
      {
        filename: '/third_party/mediapipe/modules/palm_detection/palm_detection_lite.tflite',
        start: 2341291,
        end: 4326731,
      },
    ],
