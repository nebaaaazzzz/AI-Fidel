var createMediapipeSolutionsWasm = (() => {
  ...
  return function (createMediapipeSolutionsWasm) {
    ...
    var wasmBinaryFile;
    wasmBinaryFile = 'hands_solution_simd_wasm_bin.wasm';
    ...
    var asmLibraryArg = {
      ...
      emscripten_webgpu_import_bind_group: _emscripten_webgpu_import_bind_group,
      emscripten_webgpu_import_texture: _emscripten_webgpu_import_texture,
      emscripten_webgpu_release_js_handle: _emscripten_webgpu_release_js_handle,
      ...
      mediapipe_create_utility_canvas2d: mediapipe_create_utility_canvas2d,
      mediapipe_find_canvas_event_target: _mediapipe_find_canvas_event_target,
      mediapipe_import_external_texture: mediapipe_import_external_texture,
      mediapipe_webgl_tex_image_drawable: _mediapipe_webgl_tex_image_drawable,
