...
const FinalScoreBoard = () => {
  ...
  return (
        <LevelComplete>
          <img src={stars} className=" mx-auto  md:w-2/5 w-3/5 mb-2" />
          ...
          <div className="hidden md:flex w-[90%] mb-4  ml-6 py-2 mt-4 bg-[#008867] font-bold justify-center border-[4px] border-[#05C294] shadow-[1px_1px_15px_rgba(0,136,103,0.5)]  rounded-xl">
            {t('ls')}
          </div>
        </LevelComplete>
  );
