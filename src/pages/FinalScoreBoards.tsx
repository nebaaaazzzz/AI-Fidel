  ...
  return (
        <LevelComplete all>
          <div className='flex pt-0 pb-6 flex-col gap-2 md:gap-6 justify-around '>
              ...
              <div className='flex justify-between gap-8'>
                <div className='rounded-full hidden md:block bg-[#B6B6B6] border-4 border-bg-[#9F9F9F] h-[45px] w-[45px]' />
                <div className='w-full md:w-[90%] bg-[#5B5B5B] border-4 flex justify-between items-center px-0 pl-2 md:px-8 flex-row border-[#A7A7A7] h-[45px] rounded-lg'>
