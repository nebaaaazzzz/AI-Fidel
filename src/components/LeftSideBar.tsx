...
function LeftSideBar() {
  ...
  return (
    <div
      ...
      className="fixed z-10 md:hidden csl:flex flex flex-row top-[90vh] md:top-[90vh] mx-auto left-0 right-0 w-[calc(100vw-2rem)]  shrink-0 px-3  justify-between py-4 md:w-14 md:static md:flex-col md:h-[500px]"
    >
