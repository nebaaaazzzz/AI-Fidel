...
function LeftSideBar() {
  ...
  if (Boolean(location.search.match(/learn/))) {
    ...
    Boolean(location.pathname.match(/edit-profile/)) ||
    Boolean(location.pathname.match(/profile/)) ||
    Boolean(location.pathname.match(/change-language/))
  ) {
    selected = 'profile';
  } else {
    selected = 'home';
  ...
  const home = (
    ...
    >
      <rect
        ...
        height="17.4247"
        rx="4.40332"
        fill={selected === 'home' ? active : notActive}
      />
      <rect
        y="22.8696"
        width="17.9301"
  ...
  const tasks = (
    <svg
      className="relative left-[0px] bottom-[-2px] md:left-[-4px] md:bottom-[-2px]"
      width={parseInt(widthHeight) + 8}
      height={parseInt(widthHeight) + 8}
      version="1.1"
      viewBox="0 0 700 700"
      xmlns="http://www.w3.org/2000/svg"
  ...
  const achievement = <img src={trophyIcon} className="object-contain h-6 mx-auto  rounded-xl" />;
  ...
  const game = (
    ...
    >
      <path
        d="M40.1589 15.1439C38.5467 7.99018 36.1556 3.42689 32.3231 2.31488C31.5808 2.10235 30.8111 1.99633 30.0379 2.00011C27.6818 2.00011 25.8225 3.37615 21.6264 3.37615C17.4303 3.37615 15.5675 2.00011 13.2149 2.00011C12.4094 1.99602 11.6073 2.10196 10.8316 2.31488C6.99383 3.42689 4.62282 7.99448 2.99221 15.1439C1.32743 22.4463 1.62884 28.2162 4.88305 29.3239C7.16118 30.0979 9.19835 28.4974 11.1277 26.1418C13.3183 23.4586 16.0161 22.6329 21.6264 22.6329C27.2367 22.6329 29.8294 23.4586 32.0234 26.1418C33.9511 28.4992 36.0636 30.0799 38.2812 29.3377C41.8754 28.1328 41.8246 22.5323 40.1589 15.1439Z"
        stroke={selected === 'game' ? active : notActive}
        stroke-width="3.30249"
        stroke-miterlimit="10"
      />
      <path
        d="M24.781 14.7284C25.7488 14.7284 26.5334 13.9583 26.5334 13.0084C26.5334 12.0584 25.7488 11.2883 24.781 11.2883C23.8131 11.2883 23.0286 12.0584 23.0286 13.0084C23.0286 13.9583 23.8131 14.7284 24.781 14.7284Z"
        fill={selected === 'game' ? active : notActive}
      />
      <path
        d="M28.6355 18.5124C28.2887 18.5124 27.9497 18.4114 27.6614 18.2222C27.3731 18.033 27.1485 17.7641 27.016 17.4496C26.8835 17.135 26.8491 16.7889 26.9171 16.4552C26.985 16.1214 27.1524 15.8149 27.3979 15.5745C27.6434 15.3342 27.9561 15.1707 28.2963 15.1048C28.6365 15.0389 28.989 15.0736 29.3091 15.2044C29.6292 15.3353 29.9026 15.5564 30.0947 15.8398C30.2867 16.1233 30.3887 16.4562 30.3879 16.7966C30.3867 17.2521 30.2016 17.6884 29.873 18.0101C29.5445 18.3317 29.0995 18.5124 28.6355 18.5124Z"
        fill={selected === 'game' ? active : notActive}
      />
      <path
        d="M28.6355 10.9445C29.6033 10.9445 30.3879 10.1744 30.3879 9.22444C30.3879 8.27449 29.6033 7.50439 28.6355 7.50439C27.6676 7.50439 26.8831 8.27449 26.8831 9.22444C26.8831 10.1744 27.6676 10.9445 28.6355 10.9445Z"
        fill={selected === 'game' ? active : notActive}
      />
      <path
        d="M32.4913 14.7284C33.4591 14.7284 34.2437 13.9583 34.2437 13.0084C34.2437 12.0584 33.4591 11.2883 32.4913 11.2883C31.5235 11.2883 30.7389 12.0584 30.7389 13.0084C30.7389 13.9583 31.5235 14.7284 32.4913 14.7284Z"
        fill={selected === 'game' ? active : notActive}
      />
      <path
        d="M13.2148 8.88013V17.1364M17.4206 13.0082H9.00903"
        stroke={selected === 'game' ? active : notActive}
        stroke-width="2.20166"
  ...
  const userImage = (
    <img
      ...
      className={`object-contain h-6 mx-auto  rounded-xl bg-[${
        selected === 'profile' ? active : notActive
      }]`}
    />
  );
  ...
  return (
    <div className="fixed nav-bar z-10 transition-all flex flex-row top-[90vh] md:top-[90vh] mx-auto left-0 right-0 w-[90vw] shrink-0 px-3  justify-between py-4 csl:w-14 csl:static csl:flex-col csl:h-[80vh]">
        ...
        return (
          <div
            ...
            style={{
              boxShadow:
                index == 0 ||
                (index == 1 && Boolean(location.search.match(/learn/))) ||
                (index == 2 && Boolean(location.search.match(/game/))) ||
                (index == 5 &&
                  (Boolean(location.pathname.match(/edit-profile/)) ||
                    Boolean(location.pathname.match(/profile/)) ||
                    Boolean(location.pathname.match(/change-language/))))
          ...
          >
            ...
            (index == 5 &&
              ...
              <button
                ...
                className={`absolute top-0 -z-10 w-full h-6 backdrop-blur-3xl ${
                  (index == 1 && Boolean(location.search.match(/learn/))) ||
                  (index == 2 && Boolean(location.search.match(/game/))) ||
                  (index == 4 &&
                    (Boolean(location.pathname.match(/edit-profile/)) ||
