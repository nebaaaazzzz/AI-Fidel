...
function GameLeftSide({
  ...
  if (isGameStarted) {
    return (
      <div className="border-2 rounded-3xl relative bg-white w-full cxm:w-[50%] md:w-full gap-5 md:pt-12 mt-2 md:mt-0 overflow-hidden  flex flex-[1] flex-col md:flex-col self-center border-primary  items-center justify-center md:rounded-lg p-4">
