...
function GameLeftSide({
  ...
  if (isGameStarted) {
    return (
      <div className="border-2 rounded-3xl relative w-[300px] md:w-1/2 gap-5 md:pt-12 mt-2 md:mt-0 overflow-hidden  flex flex-[1] flex-col md:flex-col self-center border-primary cxl:h-[280px] csl:h-[220px] cml:h-[300px] items-center justify-center md:rounded-lg p-4">
