...
function StartingLeft({ path }) {
  return (
    <div className="relative mt-[-20px] h-6/12 block md:mt-14 w-full md:h-full md:flex-1">
      <div className="w-full overflow-visible relative flex justify-center md:hidden csl:flex">
      ...
      <img
        src={path}
        className="md:absolute mx-auto left-0 right-0 w-[250px] md:w-[500px] csl:w-3/4 bottom-0 object-contain"
      />
    </div>
  );
}
