...
function StartingLeft({ path }) {
  return (
    <div className="relative transition-all mt-[-20px] h-6/12 block md:mt-14 w-full md:h-full md:flex-1">
      ...
      <img
        src={path}
        className="md:absolute transition-all mx-auto left-0 right-0 w-[250px] md:w-[500px] csl:w-3/4 bottom-0 object-contain"
      />
    </div>
  );
}
